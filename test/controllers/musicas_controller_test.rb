...
class MusicasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create musica" do
    assert_difference("Musica.count") do
      post musicas_url, params: { musica: { album: @musica.album, artista: @musica.artista, duracao: @musica.duracao, nome: @musica.nome, spotify_id: @musica.spotify_id } }
    end
  ...
  test "should update musica" do
    patch musica_url(@musica), params: { musica: { album: @musica.album, artista: @musica.artista, duracao: @musica.duracao, nome: @musica.nome, spotify_id: @musica.spotify_id } }
