...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference("Playlist.count") do
      post playlists_url, params: { playlist: { descricao: @playlist.descricao, nome: @playlist.nome } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { descricao: @playlist.descricao, nome: @playlist.nome } }
